...
Future<void> injectDependencies() async {
  ...
  Get.lazyPut<TaskService>(() =>
      kIsWeb ? TaskServiceImpl() : TaskGrpcService(clientChannel: GrpcConfig().clientChannel));
  ...
  Get.lazyPut<TaskRepository>(() => TaskRepositoryImpl(
      userService: Get.find<TaskService>(), taskLocalDatasource: Get.find<TaskLocalDatasource>()));
  _injectController();
}
